...
class Mdirector_Newsletter {
	 ...
	 */
	protected $mdirector_newsletter;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mdirector-newsletter-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mdirector-newsletter-i18n.php';

		/**
		 * The class responsible for calling Mdirector API
		 */

		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-mdirector-newsletter-api.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-mdirector-newsletter-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-mdirector-newsletter-public.php';
	...
	private function set_locale() {
		$plugin_i18n = new Mdirector_Newsletter_i18n();
		$plugin_i18n->set_domain( $this->get_mdirector_newsletter() );
	...
	private function define_admin_hooks() {
		$plugin_admin = new Mdirector_Newsletter_Admin( $this->get_mdirector_newsletter(), $this->get_version() );
	...
	private function define_public_hooks() {
		$plugin_public = new Mdirector_Newsletter_Public( $this->get_mdirector_newsletter(), $this->get_version() );
	 ...
	 */
	public function get_mdirector_newsletter() {
		return $this->mdirector_newsletter;
	}
